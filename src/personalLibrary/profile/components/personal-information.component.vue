<template>
  <Card
    ...
    <template #header>
      <img style="clip-path: circle(); max-width: 200px" alt="user header"
...
const languageOptions = [{label: 'English', value: 'en'}, {label: 'Español', value: 'en'}, {label: 'Frances', value: 'fr'}, {label: 'Portugues', value:'pt'}]
